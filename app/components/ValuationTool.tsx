      ...
      <section className="mt-5">
        <div className="mx-auto max-w-screen-xl px-4 lg:flex lg:items-center">
          ...
          <div className="lg:w-1/2 lg:pl-10 mt-6 lg:mt-0 text-center lg:text-left">
            <p className="text-xl text-black  font-extrabold sm:text-3xl mb-4">
              Start with some key details
            </p>
            <p className="text-xl text-black sm:text-xl">
              Flippa uses your inputs and compares data to 1000's of similar
              sites that have sold on Flippa. We look at business model,
              category, age and many other factors.
            </p>
